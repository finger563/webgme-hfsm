...
namespace state_machine::Basic {
    ...
    typedef Event<STARTEventData> STARTEvent;
    ...
    public:
      ...
      void spawn_START_event(const STARTEventData &data) { event_factory.spawn_START_event(data); }
      void spawn_STOP_event(const STOPEventData &data) { event_factory.spawn_STOP_event(data); }

      // Constructors
      Root() : StateBase(),
      BASIC_OBJ__IDLE_OBJ ( this, this ),
            BASIC_OBJ__ACTIVE_OBJ ( this, this ),
            BASIC_OBJ__END_OBJ ( this ),
      _root(this)
      {}
      ~Root(void) {}
      ...
      // Declaration for Active : /p/m/Active
      class Active : public StateBase {
      public:
        // User Declarations for the State
        //::::/p/m/Active::::Declarations::::
      ...
      public:
        ...
        // Constructors
        Active  ( Root* root, StateBase* parent ) : StateBase(parent), _root(root) {}
        ~Active ( void ) {}
      ...
      // State Objects
      Idle BASIC_OBJ__IDLE_OBJ;
      Active BASIC_OBJ__ACTIVE_OBJ;
      // END state object
      End BASIC_OBJ__END_OBJ;
